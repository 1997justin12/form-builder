  ...
  _createClass(FormContainer, [{
    ...
    value: function renderTool(field, index) {
      ...
      if (field.toolType === 'SELECT_FIELD') {
        ...
        return _react2.default.createElement(_SingleField2.default, {
          changeState: function changeState(e, index) {
            return _this4.changeChildState(e, index);
          },
          field: field,
        ...
        return _react2.default.createElement(_CheckBoxes2.default, {
          changeState: function changeState(e, index) {
            return _this4.changeChildState(e, index);
          },
          field: field,
        ...
        return _react2.default.createElement(_Paragraph2.default, {
          changeState: function changeState(e, index) {
            return _this4.changeChildState(e, index);
          },
          field: field,
